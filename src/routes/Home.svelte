        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    <span class="sr-only">Nice Name</span>
                    <h1><b>Nice Name</b></h1>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="#/auth/login"
                   class="text-sm font-semibold leading-6 text-gray-900">{!$authenticationStore.isAuthenticated ? "Log in" : "Dashboard"}
                    <span
    ...
    <div class="relative isolate pt-14">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                ...
                <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">A very nice
                    landing page title</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600">
                    A nice hook to get viewers to click the CTA
                </p>
